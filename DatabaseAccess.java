        ...
        protected Void doInBackground(Void... voids) {
            try {
                ...
                for (int i = 0; i < toAddArray.length(); i++) {
                    ...
                    String nom_vaccin = SoinsObject.getString("nom_vaccin");
                    String dose = SoinsObject.getString("dose");
                    String date_vaccin = SoinsObject.getString("date_vaccin");

                    Log.d("SynchronizeSoinsTask", "num_nat : " + num_nat);
                    Log.d("SynchronizeSoinsTask", "nom_vaccin : " + nom_vaccin);
                    Log.d("SynchronizeSoinsTask", "dose : " + dose);
                    Log.d("SynchronizeSoinsTask", "date_vaccin : " + date_vaccin);
                    Log.d("SynchronizeSoinsTask", "Ajout du vaccin : " + num_nat + " - " + nom_vaccin + " - " + dose + " - " + date_vaccin);

                    // Insérer le vaccin dans la base de données locale
                    insertSoins(num_nat, nom_vaccin, dose, date_vaccin);
                }
