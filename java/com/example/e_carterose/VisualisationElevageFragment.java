...
public class VisualisationElevageFragment extends Fragment {
    ...
    private List<Animal> activeAnimals; // Variable pour stocker la liste des animaux actifs de l'élevage
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        // Récupérer les informations de l'élevage depuis la base de données
        ...
        activeAnimals = db.getAnimalsByElevageAndActif(numElevage, 1);
        ...
        updateAnimalViews(activeAnimals);
