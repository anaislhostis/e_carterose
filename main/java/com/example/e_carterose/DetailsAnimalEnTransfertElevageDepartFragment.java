...
public class DetailsAnimalEnTransfertElevageDepartFragment extends Fragment {
    ...
    private String chooseNumNat(Animal selectedAnimal, List<Animal> allAnimalsBDD) {
        String numNat = selectedAnimal.getNumNat();

        // Si le numéro national commence par 000000, il va chercher le bon numNat dans les informations de cette vache dans le nouvel élevage de l'animal
        if(numNat.startsWith("000000")) {
            ...
            for (Animal animal : allAnimalsBDD) {
                ...
                if (isSameAnimal(animal, selectedAnimal)) {
                    // Mettre à jour le numéro national de l'animal
                    numNat = animal.getNumNat();
                    Log.e("numNatboucle", numNat);
                    return numNat;
                }
            }
        }
    ...
    private void createPDF() {
        ...
        String numNat = chooseNumNat(selectedAnimal, allAnimalsBDD);
