...
public class DetailsAnimalEnTransfertAbattoirFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment_details_animal_en_transfert_abattoir, container, false);
        ...
        Button buttonAbattoir = rootView.findViewById(R.id.buttonAbattoir);
        buttonAbattoir.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Afficher une boîte de dialogue de confirmation
                AlertDialog.Builder builder = new AlertDialog.Builder(requireContext());
                builder.setMessage("Êtes-vous sûr de vouloir déposer l'animal à l'abattoir ou de le récupérer par le transporteur ?");
                builder.setPositiveButton("Oui", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        // Mettre à jour le statut de l'animal : déclaré mort (actif=0)
                        db.updateStatus(numElevage, numTra, 0);

                        // Afficher un message de confirmation
                        Toast.makeText(requireContext(), "L'animal " + numTra + " a été déposé à l'abattoir.", Toast.LENGTH_SHORT).show();
                    }
                });
