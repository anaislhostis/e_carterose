...
public final class AnimalItemBinding implements ViewBinding {
  ...
  private AnimalItemBinding(@NonNull LinearLayout rootView, @NonNull TextView textViewDateNaiss,
      @NonNull TextView textViewNom, @NonNull TextView textViewNumTra,
  ...
  public static AnimalItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AnimalItemBinding((LinearLayout) rootView, textViewDateNaiss, textViewNom,
          textViewNumTra, textViewSexe);
    }
